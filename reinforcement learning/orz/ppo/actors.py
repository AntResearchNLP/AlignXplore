...
from orz.ppo.models import Actor, get_llm_for_sequence_regression, RewardActor
...
class genRewardRayActorBase(RayActor):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        self._setup_distributed(strategy)
        model = RewardActor(
            pretrain,
...
class judRewardRayActorBase(PolicyRayActorBase):
...
RewardRayActor = ray.remote(num_gpus=1)(judRewardRayActorBase)
